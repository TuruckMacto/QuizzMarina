...
class SastreriaQuizz extends StatefulWidget {
  const SastreriaQuizz({super.key});

  @override
  State<SastreriaQuizz> createState() => _SastreriaQuizzState();
}

class _SastreriaQuizzState extends State<SastreriaQuizz> {
  var db = DBconnectCn();
